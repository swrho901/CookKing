...
public class MainActivity extends Activity {
    ...
    public void setAlarm() {
        ...
        String from = "2022-05-26 20:50:00"; //임의로 날짜와 시간을 지정
        String from2 = "";
        for(int i=0;i<dateIndex;i++) {
            ...
            int date11 = Integer.parseInt(ymd[2]);
            date11 -= 3;
            if(date11 >= 1) {
                if (ymd[1].length() == 2) {
                ...
                String s1 = Integer.toString(date11);
                if (s1.length() == 2) {
                    from2 = from2.concat(s1 + " ");
                } else {
                    from2 = from2.concat("0" + s1 + " ");
                }
            }
            else{
                int month11 = Integer.parseInt(ymd[1]);
                month11--;
                String s2 = Integer.toString(month11);
                if (s2.length() == 2) {
                    from2 = from2.concat(s2 + "-");
                } else {
                    from2 = from2.concat("0" + s2 + "-");
                }
                date11 += 30;
                String s1 = Integer.toString(date11);
                if (s1.length() == 2) {
            ...
            from2 = from2.concat("11:00:00"); // 시간 조정
            from = from2;
